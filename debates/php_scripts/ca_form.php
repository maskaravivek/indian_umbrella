...
mysql_query("INSERT INTO user_data(Name,Gender,College,State_in_degree,Contact, Email,resume_link) VALUES('$name','$gender','$univ','$state','$contact','$email','$resume')")  ;
...
mysql_query("INSERT INTO ca_application(user_data_id,past,why_join,strategy) VALUES ('$user_data_id','$past','$why','$strategy')");
$app_type="ca";
$status="new";
$application_ref="TIU/CA"."/".$user_data_id;
