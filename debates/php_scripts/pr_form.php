...
$how_social=$_POST['how_social'];
$answer=$_POST['answer'];
mysql_query("INSERT INTO pr_application(user_data_id,past,why_join,strategy,how_social,answer) VALUES ('$user_data_id','$past','$why','$strategy','$how_social','$answer')");
$app_type="pr";
$status="new";
$application_ref="TIU/PR/".$user_data_id;
