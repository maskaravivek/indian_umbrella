...
if($no==0)
{
header("Location: login.php?url=newsandevents.php");
}}
else
{
...
<link rel="stylesheet" href="../css/table_style.css" />
    ...
    if(isset($_POST['description']) && isset($_POST['link']) && isset($_POST['title'])){
        ...
        if(!empty($description) && !empty($link) && !empty($title)){
			if(mysql_query("INSERT INTO news (description,link,title) VALUES ('$description','$link','$title')")){
	...
	?>
	<form method="post" class="formee" id="test" action="newsandevents.php">
	<fieldset>
