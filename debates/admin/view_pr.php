...
if($no==0)
header("Location: login.php?url=view_pr.php?id=".$_GET['id']);
}
else
header("Location: login.php?url=view_pr.php?id=".$_GET['id']);
$app_id=$_GET['id'];
...
$sql2=mysql_query("SELECT * from pr_application WHERE user_data_id='$id'");
			...
			<div class="yui-gc">
				...
				<div class="yui-u">
					<div class="contact-info">
						...
						<?php if($status=="new") {?>
						<a id="pdf" style="margin-right:2px;" href="view_pr.php?id=<?php echo $id;?>&action=approve">Approve</a>
						<a id="pdf" href="view_pr.php?id=<?php echo $id;?>&action=reject">Reject</a></h3>
						<?php }
						else if($status=="approved"){?>
						<a id="pdf" style="margin-right:2px;" href="view_pr.php?id=<?php echo $id;?>&action=reject">Reject</a>
						<?php } 
		...
		<div id="bd">
			<div id="yui-main">
				<div class="yui-b">
					...
					<div class="yui-gf">
						<div class="yui-u first">
							<h2>Strategy to increase market presence..</h2>
						</div>
						<div class="yui-u">
					...
					<div class="yui-gf">
						<div class="yui-u first">
							<h2>How would I use social media platforms..</h2>
						</div>
						<div class="yui-u">
							<p class="enlarge"><?php echo $how ?></p>
						</div>
					</div>
					<div class="yui-gf">
						<div class="yui-u first">
							<h2>This is how i will publicize the debate event..</h2>
						</div>
						<div class="yui-u">
							<p class="enlarge"><?php echo $answer ?></p>
						</div>
					</div>
