...
<title>Application Form PR</title>
...
<li><p>Pre event and post event publicity on various social media platforms to boost the viewership</p></li>
<li><p>Coming up with innovative ideas to be implemented to increase the visibility of the events and organization</p></li>
<li><p>Various other online and offline activities to help and promote the brand/ services</p></li>
<li><p>Generate Content relevant to publicity</p></li>
<li><p>Approach distinguished people as Advisors / debate experts on board and conduct interviews</p></li>
...
<li><p>Enjoy a good networking of policy or other experts, entrepreneurs</p></li>
   ...
   <form method="post" class="formee" action="../debates/php_scripts/pr_form.php" id="test" enctype="multipart/form-data" >
<fieldset>
...
<div class="grid-6-12">
<label>Profession<em class="formee-req">*</em></label><input type="text" name="university"><br>
</div>
<div class="grid-6-12">
...
<blockquote>Mention in brief the strategy to increase market presence and widen the consumer base(150 words)</blockquote>
<textarea name="strategy" rows="4" cols="100"></textarea>
<blockquote>How would you use social media platforms for the purpose of publicity of the organization and its events? (Max 100 words)</blockquote>
<textarea name="how_social" rows="4" cols="100"></textarea>
<blockquote>Suppose there is debate going on currently on the topic 'The Indian Government made a big mistake in not raising the oil and gas prices earlier'. Write a short paragraph on the aforesaid topic that can be used to publicize the debate event. (150 words)</blockquote>
