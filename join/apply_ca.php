...
<title>Application Form CA</title>
...
<div class='tabbed_content'>
					...
					<div class='slide_content'>						
						<div class='tabslider'>
							<ol class="rounded-list">
								<li><p>Represent us on campus by pro-actively appraoching debating and quizzing societies/clubs in respective colleges for collaboration</p></li>
								<li><p>Leverage your personal network in order to create awareness and stimulate interest across the campus through conversations and meetings with other students</p></li>
								<li><p>Promote and publicize the organization and its events</p></li>
								<li><p>Create events, activities, and opportunities that help students best use Debating Platform</p></li>
								<li><p>Collect campus feedback through focus groups, surveys, and individual interviews</p></li>
								<li><p>Participate in conference calls, team trainings, and regularly scheduled team meetings</p></li>
								<li><p>Average time commitment: 5-10 hours per week</p></li>
								<li><p>Organizing annual National Debating Conferences</p></li>
								<li><p>Approach distinguished people as Advisors / debate experts on board and handle them from initiation to end</p></li>
							</ol>
							<ol class="rounded-list">
								<li><p>Opportunity to initiate and lead one's own chapters in campuses, cities  </p></li>
								<li><p>Exposure of working in a youth-led organization, progressively moving to higher regional/ national ownership roles on performance evaluation</p></li>
   ...
   <form method="post" class="formee" action="../debates/php_scripts/ca_form.php" id="test" enctype="multipart/form-data" >
<fieldset>
...
<div class="grid-6-12">
<label>University/College<em class="formee-req">*</em></label><input type="text" name="university"><br>
</div>
<div class="grid-6-12">
<label>State in degree(year)<em class="formee-req">*</em></label><input type="text" name="state"><br>
</div>
<div class="grid-6-12">
...
<blockquote>Mention in brief the Publicity Strategy and the Channels you would adopt to publicize the organization and its events. (150 words)</blockquote>
