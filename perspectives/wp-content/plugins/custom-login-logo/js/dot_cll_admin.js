    ...
    $( function() {
        $.fn.dot_cll = function( options ) {
            ...
            $( options.button ).click( function() {
                ...
                tb_show( 'Upload a logo', 'media-upload.php?referer=dot_cll&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).dot_cll(); // Use as default option.
    } );
} ( jQuery ) );